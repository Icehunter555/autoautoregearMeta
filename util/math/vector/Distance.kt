...
import dev.fastmc.common.DistanceKt as FastDistance
...
fun Vec3i.distanceToCenter(x: Double, y: Double, z: Double): Double {
    return FastDistance.distance(this.x + 0.5, this.y + 0.5, this.z + 0.5, x, y, z)
}

fun Vec3i.distanceSqToCenter(x: Double, y: Double, z: Double): Double {
    return FastDistance.distanceSq(this.x + 0.5, this.y + 0.5, this.z + 0.5, x, y, z)
}

fun Vec3i.distanceToCenter(vec3d: Vec3d): Double {
    return distanceToCenter(vec3d.x, vec3d.y, vec3d.z)
}

fun Vec3i.distanceSqToCenter(vec3d: Vec3d): Double {
    return distanceSqToCenter(vec3d.x, vec3d.y, vec3d.z)
}

fun Vec3i.distanceTo(x: Int, y: Int, z: Int): Double {
    return FastDistance.distance(this.x, this.y, this.z, x, y, z)
}

fun Vec3i.distanceSqTo(x: Int, y: Int, z: Int): Int {
    return FastDistance.distanceSq(this.x, this.y, this.z, x, y, z)
}
...
fun Vec3i.distanceSqTo(vec3i: Vec3i): Int {
    return distanceSqTo(vec3i.x, vec3i.y, vec3i.z)
}
...
fun Vec3d.distanceToCenter(x: Int, y: Int, z: Int): Double {
    return FastDistance.distance(this.x, this.y, this.z, x + 0.5, y + 0.5, z + 0.5)
}

fun Vec3d.distanceSqToCenter(x: Int, y: Int, z: Int): Double {
    return FastDistance.distanceSq(this.x, this.y, this.z, x + 0.5, y + 0.5, z + 0.5)
}
...
fun Entity.distanceTo(x: Double, y: Double, z: Double): Double {
    return FastDistance.distance(posX, posY, posZ, x, y, z)
}

fun Entity.distanceSqTo(x: Double, y: Double, z: Double): Double {
    return FastDistance.distanceSq(posX, posY, posZ, x, y, z)
}
...
fun Entity.distanceToCenter(x: Int, y: Int, z: Int): Double {
    return FastDistance.distance(posX, posY, posZ, x + 0.5, y + 0.5, z + 0.5)
}

fun Entity.distanceSqToCenter(x: Int, y: Int, z: Int): Double {
    return FastDistance.distanceSq(posX, posY, posZ, x + 0.5, y + 0.5, z + 0.5)
}
...
fun Entity.hDistanceTo(x: Double, y: Double): Double {
    return FastDistance.distance(posX, posY, x, y)
}

fun Entity.hDistanceSqTo(x: Double, y: Double): Double {
    return FastDistance.distanceSq(posX, posY, x, y)
}

fun Entity.hDistanceToCenter(x: Int, y: Int): Double {
    return FastDistance.distance(posX, posY, x + 0.5, y + 0.5)
}

fun Entity.hDistanceSqToCenter(x: Int, y: Int): Double {
    return FastDistance.distanceSq(posX, posY, x + 0.5, y + 0.5)
}
