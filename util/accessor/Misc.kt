...
import dev.wizard.meta.mixins.accessor.*
import dev.wizard.meta.mixins.accessor.entity.AccessorEntity
import dev.wizard.meta.mixins.accessor.entity.AccessorEntityTippedArrow
...
val Entity.isInWeb: Boolean
    get() = (this as AccessorEntity).troll$getIsInWeb()

val Entity.inPortal: Boolean
    get() = (this as AccessorEntity).troll$getInPortal()
...
val ItemTool.attackDamage: Float
    get() = (this as AccessorItemTool).attackDamage

val Minecraft.timer: Timer
    get() = (this as AccessorMinecraft).trollGetTimer()

val Minecraft.renderPartialTicksPaused: Float
    get() = (this as AccessorMinecraft).renderPartialTicksPaused
...
val BlockStateContainer.storage: BitArray
    get() = (this as AccessorBlockStateContainer).trollGetStorage()

val BlockStateContainer.palette: IBlockStatePalette
    get() = (this as AccessorBlockStateContainer).trollGetPalette()
