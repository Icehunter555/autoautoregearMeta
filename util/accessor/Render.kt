...
import dev.wizard.meta.mixins.accessor.render.AccessorDestroyBlockProgress
import dev.wizard.meta.mixins.accessor.render.AccessorRenderGlobal
import dev.wizard.meta.mixins.accessor.render.AccessorRenderManager
import dev.wizard.meta.mixins.accessor.render.AccessorShaderGroup
...
val DestroyBlockProgress.entityID: Int
    get() = (this as AccessorDestroyBlockProgress).trollGetEntityID()

val RenderGlobal.entityOutlineShader: ShaderGroup
    get() = (this as AccessorRenderGlobal).entityOutlineShader

val RenderGlobal.entityOutlineFramebuffer: Framebuffer
    get() = (this as AccessorRenderGlobal).trollGetEntityOutlineFramebuffer()

val RenderGlobal.damagedBlocks: Map<Int, DestroyBlockProgress>
    get() = (this as AccessorRenderGlobal).trollGetDamagedBlocks()
